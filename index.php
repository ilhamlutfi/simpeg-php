  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="assets/gambar/bola1.jpg" style="background-size: cover; max-height: 50%;" width="100%">
      ...
      <div class="carousel-item">
        <img src="assets/gambar/bola2.jpg" style="background-size: cover; max-height: 50%;" width="100%">
